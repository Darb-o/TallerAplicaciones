        ...
        <div class="row">
            <div class="col-12 col-md-4">
                ...
                <div class="col-12 col-sm-6">
                    <input type="text" placeholder="Nombres" required class="form-control" id="Nombre" name="Nombre">
                </div>
                <div class="col-12 col-sm-6">
                    <input type="text" placeholder="Apellidos" required class="form-control" id="Apellido" name="Apellido">
                </div>
                <div class="col-12 col-sm-6">
                ...
                <div class="col-12 col-sm-6 input-group">
                    ...
                    <input type="text" readonly="true" placeholder="Digite cargo" required class="input-group-text" id="InputCargo" name="InputCargo">
                </div> 
                <div class="col-12 col-sm-6 input-group">
                    ...
                    <input type="text" readonly="true" placeholder="Digite costo" required class="input-group-text" id="InputCosto" name="InputCosto"> 
                </div>
                <div class="col-12 col-sm-6">
